      ...
      <main className="flex-1">
        ...
        <section className="bg-gray-50 py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-center text-[#111111] mb-12">
              So einfach geht's
            </h2>
            <div className="grid sm:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <div className="text-xs font-bold text-[#2563eb] mb-2 uppercase tracking-wider">
                    Schritt {item.step}
                  </div>
        ...
        <section className="bg-white py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-center text-[#111111] mb-4">
              Transparente Preise
            </h2>
            <p className="text-center text-gray-500 mb-12">
              Keine versteckten Kosten. Behördengebühren separat.
            </p>
              ...
              {[
                {
                  name: "Abmeldung",
                  price: "19",
                  features: ["Fahrzeug abmelden", "Bestätigung per E-Mail", "24h Service"],
                  highlight: false,
                },
                {
                  name: "Anmeldung",
                  price: "29",
                  features: ["Fahrzeug anmelden", "inkl. SEPA-Einzug", "24h Service", "KI-Prüfung"],
                  highlight: true,
                },
                {
                  name: "Halterwechsel",
                  price: "39",
                  features: ["Besitzer wechseln", "Komplett-Service", "24h Service", "KI-Prüfung"],
                  highlight: false,
                },
              ].map((plan) => (
                <div
                ...
                >
                  ...
                  <h3 className={`font-bold text-lg mb-1 ${plan.highlight ? "text-white" : "text-[#111111]"}`}>
                    {plan.name}
                  </h3>
                  <div className={`text-4xl font-bold mb-6 ${plan.highlight ? "text-white" : "text-[#111111]"}`}>
                    {plan.price}€
                  </div>
                  <ul className="space-y-2 mb-8">
                    {plan.features.map((f) => (
                      <li key={f} className={`flex items-center gap-2 text-sm ${plan.highlight ? "text-blue-100" : "text-gray-600"}`}>
                        <CheckCircle size={16} className={plan.highlight ? "text-blue-200" : "text-[#2563eb]"} />
                        {f}
                      </li>
                    ))}
                  </ul>
              ...
              {[
                {
                  ...
                  desc: "Alle Daten werden sicher übertragen und gespeichert.",
                },
                {
                  icon: <Shield size={24} className="text-[#2563eb]" />,
                  title: "DSGVO konform",
                  desc: "Ihre Daten werden nach deutschem Datenschutzrecht verarbeitet.",
                },
                {
                  icon: <Clock size={24} className="text-[#2563eb]" />,
                  title: "24h Service",
                  desc: "Werktags innerhalb von 24 Stunden erledigt.",
                },
              ].map((badge) => (
